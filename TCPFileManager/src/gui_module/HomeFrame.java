...
public class HomeFrame extends JFrame{
    ...
    private JPanel message_panel, files_panel, upload_panel, button_panel;
    private JScrollPane user_list_panel;
    ...
    private void initUIElements(Socket socket) {
        ...
        user_list_panel = new JScrollPane();
    ...
    private void addUIElements() {
        ...
        user_list_panel.setViewportView(user_list);
        user_list_panel.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
        user_list_panel.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED);
    ...
    private void commandListener(Socket socket) throws IOException{
        while(true)
        {
            ...
            if(str.contains("uList:")) {
                ...
                data[0] = "LIST OF ALL USERS:";
                System.out.println(Arrays.toString(data));
                user_list.removeAll();
                user_list.setListData(data);
                user_list.updateUI();
            }
        }
    }
